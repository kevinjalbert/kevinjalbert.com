...
- http caching
pubDate: 2018-07-17
heroImage: ../images/2018-07-17-graphql-persisted-queries-with-http-caching-part-3/post-query.png
heroImageAlt: "'Generated with [Carbon.now.sh](https://carbon.now.sh/)'"
---

This is the third part of a four-part series on GraphQL Pesisted Queries with HTTP Caching. As a recap of [[graphql-persisted-queries-with-http-caching-part-2|part two]], we created an Express server and React application, both using persisted queries.
