...
description: >-
  In this post, I present two ways to wrap a shell command and keep its original
  name. This allows you to run additional statements before and after the
  execution of a command that you don't own.
tags:
  - tools
  - shell
  - terminal
pubDate: 2021-02-27T00:00:00.000Z
heroImage: assets/shell-book.jpg
heroImageAlt: >-
  '[Shell](https://flickr.com/photos/30403793@N03/9664491018 "Shell") by
  [snap713](https://flickr.com/people/30403793@N03) is licensed under [CC
  BY-NC-ND](https://creativecommons.org/licenses/by-nc-nd/2.0/)'
permalink: wrapping-shell-commands-and-keep-the-original-name
---
