...
description: >-
  I want to share how I integrate my Weekly Notion Setup with Google Assistant.
  It provides a ubiquitous way to interact with Notion. In particular, this
  solution opens up new ways to add notes and tasks in Notion via voice
  commands.
tags:
  - notion
  - google-assistant
...
heroImage: assets/ifttt-and-repo.png
heroImageAlt: >-
  'My Google Assistant IFTTT Applets alongside the `notion-heroku` GitHub
  repository'
permalink: integrating-notion-with-google-assistant
---
