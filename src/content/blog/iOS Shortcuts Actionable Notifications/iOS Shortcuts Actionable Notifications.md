...
description: >-
  Sometimes, you need a notification to do something when you tap on it like
  opening an app or running a shortcut. Unfortunately, the native 'Show
...
heroImageAlt: '''Two actionable notifications (via Pushcut and Toolbox Pro) on my iOS device.'''
permalink: ios-shortcuts-actionable-notifications
---
...
![Native Notification](assets/native-notification.jpeg)
...
![Pushcut notification example](assets/pushcut-notification.jpeg)

![Toolbox Pro notification example](assets/toolboxpro-notification.jpeg)
...
The beauty of actionable notifications is that they can open URLs. URLs then let you take advantage of URL Schemes. I'm going to pull some quotes from a [[../Using URL Scheme Links in Notion/Using URL Scheme Links in Notion|previous article]] I wrote that describes them:
...
![Actionable notification demonstration showing transition from notification to Just Press Record app](assets/actionable-notification.gif)
