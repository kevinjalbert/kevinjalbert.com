...
description: >-
  Set up a hyper key and global hotkeys to quickly perform actions regardless of
  where you are. This will save you keystrokes and/or time spent moving the
  mouse cursor.
tags:
  - productivity
  - macos
...
heroImageAlt: >-
  My Alfred Workflow that holds my global hotkeys to open applications, also
  showing the hyper key setup via Karabiner-Elements.
permalink: global-hotkeys-using-the-hyper-key
---
...
![Alfred Trigger Config](assets/alfred-trigger-config.png)
