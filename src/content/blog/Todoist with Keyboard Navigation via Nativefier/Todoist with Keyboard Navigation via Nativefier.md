...
description: >-
  Todoist does not have strong keyboard navigation and shortcuts. Fortunately,
  there is a browser extension that augments the web client to support better
  keyboard navigation. This article outlines how to gain this functionality in a
  desktop version of Todoist using 'nativefier'.
tags:
  - productivity
  - tools
pubDate: 2018-09-30T00:00:00.000Z
heroImage: assets/todoist-keyboard.jpg
heroImageAlt: '''My MacBook Pro displaying "TODOIST"'''
permalink: todoist-with-keyboard-navigation-via-nativefier
---
