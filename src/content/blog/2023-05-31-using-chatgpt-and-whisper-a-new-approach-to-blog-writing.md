...
- Writing
pubDate: 2023-05-31
heroImage: ../images/2023-05-31-using-chatgpt-and-whisper-a-new-approach-to-blog-writing/robot-typing.jpg
heroImageAlt: "'An AI-generated image (using [BlueWillow](https://www.bluewillow.ai/)) with the prompt \"A robot typing on a computer, simple design\"'"
---

For my previous [[using-excalidraws-embedded-scene-feature-for-collaborative-diagramming|blog article on Excalidraw's embedded scene]], I wrote the post with the assistance of ChatGPT and Whisper. Today, I wanted to share more about how I approached this process and discuss the concept of grounding the model. Additionally, I'll touch on the use of the Whisper model for accurate transcriptions. Let's dive in!
