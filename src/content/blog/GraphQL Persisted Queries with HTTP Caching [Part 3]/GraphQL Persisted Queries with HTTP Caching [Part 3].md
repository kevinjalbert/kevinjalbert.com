...
description: >-
  This is the third of four parts on GraphQL Persisted Queries with HTTP
  Caching. We continue our journey with creating a Rails GraphQL API,
  synchronizing queries to it, and adapting it to use persisted queries.
tags:
  - graphql
  - rails
  - express
  - http-caching
pubDate: 2018-07-17T00:00:00.000Z
heroImage: assets/post-query.png
heroImageAlt: '''Generated with [Carbon.now.sh](https://carbon.now.sh/)'''
permalink: graphql-persisted-queries-with-http-caching-part-3
---

This is the third part of a four-part series on GraphQL Pesisted Queries with HTTP Caching. As a recap of [[../GraphQL Persisted Queries with HTTP Caching [Part 2]/GraphQL Persisted Queries with HTTP Caching [Part 2]|part two]], we created an Express server and React application, both using persisted queries.
