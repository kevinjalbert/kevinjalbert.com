...
description: >-
  When working with branches, often you are focusing on a specific part of the
  codebase. Sometimes, a commit in a string of commits can cause failures
  elsewhere. Check out my script on bisecting the current branch and catch the
  commit that introduced the error.
tags:
  - git
  - git bisect
  - tool
pubDate: 2022-08-31T00:00:00.000Z
heroImage: assets/broken-chain.jpg
heroImageAlt: >-
  '[Las cadenas se cortan por el eslabón mas débil / Chains break by the weakest
  link](https://flickr.com/photos/hernanpc/7115374283 "Las cadenas se cortan por
  el eslabón mas débil / Chains break by the weakest link") by
  [hernanpba](https://flickr.com/people/hernanpc) is licensed under [CC
  BY-SA](https://creativecommons.org/licenses/by-sa/2.0/)'
permalink: git-bisect-only-the-current-branch
---
