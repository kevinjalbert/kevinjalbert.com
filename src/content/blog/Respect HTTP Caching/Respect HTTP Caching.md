...
description: >-
  ...
  scale. One effective way to mitigate load is to use HTTP caching. As
  developers we need to respect HTTP caching to not waste efforts.
tags:
  - http
  - caching
pubDate: 2015-09-24T00:00:00.000Z
permalink: respect-http-caching
---
...
![[assets/200-status-code-chrome.png|First Request results in a Status Code 200]]
...
![[assets/304-status-code-chrome.png|Second Request results in a Status Code 304]]
