...
description: >-
  My first foray into making and publishing a browser extension. Let me showcase
  a quick extension which adds a button on GitHub's pull request and issue pages
  that links to tellmewhenitcloses.com populated with data.
tags:
  - github
  - tools
pubDate: 2017-11-14T00:00:00.000Z
heroImage: assets/screenshot.jpg
heroImageAlt: >-
  '[Screenshot of GitHub: Tell Me When It Closes
  Extension](https://github.com/kevinjalbert/github-tell-me-when-it-closes-extension)'
