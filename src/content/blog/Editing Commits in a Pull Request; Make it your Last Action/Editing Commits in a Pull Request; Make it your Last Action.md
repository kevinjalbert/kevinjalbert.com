...
description: >-
  If you are going to edit commits in a collapsing fashion (i.e., amend/squash)
  in a pull request, make it your last action before merging to avoid confusing
  code reviewers.
tags:
  - process
  - git
...
heroImage: assets/pair-programming.jpg
heroImageAlt: >-
  '[Pair Programming](https://flickr.com/photos/glodjib/16146549307 "Pair
  Programming") by [haslo](https://flickr.com/people/glodjib) is licensed under
  [CC BY-NC-ND](https://creativecommons.org/licenses/by-nc-nd/2.0/)'
permalink: editing-commits-in-a-pull-request-make-it-your-last-action
---
