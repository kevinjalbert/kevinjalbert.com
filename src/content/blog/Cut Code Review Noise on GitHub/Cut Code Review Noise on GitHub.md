...
description: >-
  Code reviews on GitHub can be noisy and contain a lot of unnecessary chatter.
  We explore how to effectively coordinate code reviewing a pull request using
...
heroImageAlt: >-
  '[Painting scissors with light 4 by Zechariah  Judy, on
  Flickr](https://www.flickr.com/photos/9918311@N02/4268582634/in/photostream/)'
permalink: cut-code-review-noise-on-github
---
...
![Reviewers State 1](assets/reviewers-state-1.png)
...
![Reviewers State 2](assets/reviewers-state-2.png)
...
![Reviewers State 3](assets/reviewers-state-3.png)
...
![Reviewers State 4](assets/reviewers-state-4.png)
...
![Reviewers State 5](assets/reviewers-state-5.png)
...
![Reviewers State 6](assets/reviewers-state-6.png)
...
![Reviewers State 7](assets/reviewers-state-7.png)
