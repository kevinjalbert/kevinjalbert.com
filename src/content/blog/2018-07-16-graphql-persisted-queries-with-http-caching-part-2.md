...
- http caching
pubDate: 2018-07-16
heroImage: ../images/2018-07-16-graphql-persisted-queries-with-http-caching-part-2/post-query.png
heroImageAlt: "'Generated with [Carbon.now.sh](https://carbon.now.sh/)'"
---

This is the second part of a four part series on GraphQL Persisted Queries with HTTP Caching. As a recap of [[graphql-persisted-queries-with-http-caching-part-1|part one]], we described some issues with GraphQL and how persisted queries can be a solution for them. We also covered what persisted queries were from a high-level.
