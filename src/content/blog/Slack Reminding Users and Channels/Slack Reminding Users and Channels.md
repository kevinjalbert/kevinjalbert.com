...
description: >-
  Slack Reminders are powerful, maybe even more so than you originally thought?!
  In my experience, I noticed that colleagues of mine didn't fully use reminders
  to their fullest extent.
tags:
  - communication
  - collaboration
  - productivity
pubDate: 2017-12-02T00:00:00.000Z
heroImage: assets/slack-reminders.jpg
heroImageAlt: Screeshot of Slack's Reminder Help
permalink: slack-reminding-users-and-channels
---

[Slack](https://slack.com/) has taken over communication for workplace environments, at least within tech circles surrounding me. I realize there are many competitors, and I have even used some of them in the past, but to me Slack is my preferred choice. If you haven't given Slack a try, I highly recommend it! At [theScore](https://www.scoremediaandgaming.com/about) we heavily use Slack.
...
![Slack Remind Me](assets/slack-remind-me.jpg)
...
![Slack Remind User](assets/slack-remind-user.jpg)
...
![Slack Remind Target List](assets/slack-remind-target-list.jpg)

Regardless, when the reminder does trigger, Aaron can interact with it. In this case he'll mark it as completed.

![Slack Remind Target Trigger](assets/slack-remind-target-trigger.jpg)

I received confirmation that he has seen and acted on the reminder I assigned him.

![Slack Remind Target Completed](assets/slack-remind-target-completed.jpg)
...
![Slack Remind Channel](assets/slack-remind-channel.jpg)
...
![Slack Remind Channel Announcement](assets/slack-remind-channel-announcement.jpg)
...
![Slack Remind List](assets/slack-remind-list.jpg)
