...
- Google
pubDate: 2023-02-27
heroImage: ../images/2023-02-27-making-airplay-work-with-chromecast-devices/airplay-list.png
heroImageAlt: "Screenshot of my Google Home speakers showing up under the AirPlay selection list within Apple's Music app in macOS."
---

This is another quick post in which I want to share and praise a new tool/service I've been using.

Continuing from my [[getting-non-homekit-devices-working-in-homekit|previous efforts to get non-apple devices to work with Homekit]], I decided to make my Google Nest/Home speakers work with AirPlay.
