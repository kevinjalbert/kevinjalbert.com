...
description: >-
  Version control is something that all developers have to work through. It is
  such an essential part of working in the software field, especially in teams.
  There are many tools, utilities, commands and scenarios to learn. One facet
  that sometimes is overlooked is the *commit message* itself.
tags:
  - process
  - communication
  - version-control
...
permalink: level-up-your-commit-messages
---
