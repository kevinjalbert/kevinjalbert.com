...
description: >-
  Pronto runners provides an automatic mechanism to find offenses in code
  reviews. Learn the essentials of pronto runners so that you can build your
  own.
tags:
  - ruby
  - pronto
...
heroImageAlt: >-
  'By Vanillase (Own work) [CC BY-SA
  3.0](http://creativecommons.org/licenses/by-sa/3.0), via [Wikimedia
  Commons](https://commons.wikimedia.org/wiki/File:ASIMO_Conducting_Pose_on_4.14.2008.jpg)'
permalink: create-your-own-pronto-runner
---
