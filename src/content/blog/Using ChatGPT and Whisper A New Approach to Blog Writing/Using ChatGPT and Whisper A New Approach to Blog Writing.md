...
description: >-
  This article explores the use of ChatGPT and Whisper for blog writing. Learn
  the importance of grounding the model to ensure accuracy and avoid false
  information. I leverage Whisper's speech recognition system to provide text on
...
heroImageAlt: >-
  ...
  the prompt "A robot typing on a computer, simple design"'
permalink: using-chatgpt-and-whisper-a-new-approach-to-blog-writing
---
For my previous [[../Using Excalidraws Embedded Scene Feature for Collaborative Diagramming/Using Excalidraws Embedded Scene Feature for Collaborative Diagramming|blog article on Excalidraw's embedded scene]], I wrote the post with the assistance of ChatGPT and Whisper. Today, I wanted to share more about how I approached this process and discuss the concept of grounding the model. Additionally, I'll touch on the use of the Whisper model for accurate transcriptions. Let's dive in!

## Using ChatGPT to Create Blog Posts

To begin, I wanted to utilize [ChatGPT](https://chatgpt.com/) to generate an entire blog post on a specific topic. However, it's important to note that [Large Language Models (LLM)](https://en.wikipedia.org/wiki/Large_language_model) (to which ChatGPT is) can occasionally produce false information, leading to what is known as [_hallucinations_](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)). Therefore, it's crucial to double-check the content generated by the model to ensure accuracy.
...
To ground my conversation with ChatGPT, I needed to provide text on the topic. I figured the best way would be to just _talk_ about it, and turn that into a text transcription. [Whisper](https://openai.com/index/whisper/) is another AI tool I can leverage, which is a highly accurate speech recognition system.
