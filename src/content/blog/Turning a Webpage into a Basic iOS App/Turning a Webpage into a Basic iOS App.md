...
description: >-
  iOS applications for the most part end up being an entry point based on
  intent. Sometimes these tasks are isolated to a webpage (in the form of an
  application) and have no native iOS application. Read how we can turn a
  webpage into a basic iOS application to reduce friction and improve focus to
  handle intents.
tags:
  - ios
  - productivity
pubDate: 2022-12-31T00:00:00.000Z
heroImage: assets/shortcut.jpg
heroImageAlt: '''Screenshot of the "Make app from url" shortcut displayed on macOS'''
permalink: turning-a-webpage-into-a-basic-ios-app
---
