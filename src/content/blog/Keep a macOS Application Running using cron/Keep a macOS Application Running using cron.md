...
description: >-
  Read how I use cron to keep the RescueTime Application running. I was
  frustrated at RescueTime crashing and not recording data for a whole week.
tags:
  - macos
  - tools
  - cron
pubDate: 2021-05-28T00:00:00.000Z
heroImage: assets/rescuetime-email.png
heroImageAlt: Screenshot of RescueTime email notifying me it hasn't been running.
permalink: keep-a-macos-application-running-using-cron
---
