...
- tools
pubDate: 2019-06-17
heroImage: ../images/2019-06-17-integrating-notion-with-alfred/workflow.png
...
I like to use tools that are an extension of my hand and mind. If the tool does not bend to my will then I need to tailor it to do so. I've done this many times before, to which I normally share the end result (i.e., [[synchronizing-my-dotfiles|how I synchronize my dotfiles]], [[todoist-with-keyboard-navigation-via-nativefier|adding keyboard navigation to Todoist on MacOS]], amongst other examples).
