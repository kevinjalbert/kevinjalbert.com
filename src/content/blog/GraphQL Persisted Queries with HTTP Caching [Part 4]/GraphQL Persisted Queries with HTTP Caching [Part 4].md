...
description: >-
  This is the last of four parts on GraphQL Persisted Queries with HTTP Caching.
  We end by adding HTTP caching to our Express, Rails and React applications.
tags:
  - graphql
  - rails
  - express
...
permalink: graphql-persisted-queries-with-http-caching-part-4
---

This is the last part of a four-part series on GraphQL Persisted Queries with HTTP Caching. As a recap of [[../GraphQL Persisted Queries with HTTP Caching [Part 3]/GraphQL Persisted Queries with HTTP Caching [Part 3]|part three]], we created a Rails application capable of handling persisted queries.
