...
- tools
pubDate: 2022-10-31
heroImage: ../images/2022-10-31-ios-shortcuts-actionable-notifications/notifications.jpg
...
![Pushcut notification example](../images/2022-10-31-ios-shortcuts-actionable-notifications/pushcut-notification.jpeg)

![Toolbox Pro notification example](../images/2022-10-31-ios-shortcuts-actionable-notifications/toolboxpro-notification.jpeg)
...
The beauty of actionable notifications is that they can open URLs. URLs then let you take advantage of URL Schemes. I'm going to pull some quotes from a [[using-url-scheme-links-in-notion|previous article]] I wrote that describes them:
...
![Actionable notification demonstration showing transition from notification to Just Press Record app](../images/2022-10-31-ios-shortcuts-actionable-notifications/actionable-notification.gif)
