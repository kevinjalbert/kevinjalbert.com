...
description: >-
  I really like how Raindrop.io handles highlights and bookmarking in general.
  As of the time of writing, there isn't any official solution to import
  Raindrop.io highlights into Readwise. Check out my script that bridges this
  gap until an official integration exists.
tags:
  - knowledge
  - raindrop
  - readwise
pubDate: 2022-06-28T00:00:00.000Z
heroImage: assets/output.png
heroImageAlt: >-
  'The output of the import script. Generated with
  [Carbon.now.sh](https://carbon.now.sh/).'
permalink: import-raindrop-io-highlights-into-readwise
---
