...
description: >-
  If you use two fonts in Google Docs often (i.e., like using mono fonts for
  code keywords) then read my approach to toggling between two fonts quickly
...
heroImage: assets/signs-fonts.jpg
heroImageAlt: >-
  '[blackjack](https://flickr.com/photos/beckettgirlphotos/43821835480
  "blackjack") by [Rural Warrior
  Photography](https://flickr.com/people/beckettgirlphotos) is licensed under
  [CC BY-ND](https://creativecommons.org/licenses/by-nd/2.0/)'
permalink: quickly-toggle-fonts-in-google-docs
---
...
![Toggle Font Mouse](assets/assets/toggle-font-mouse.gif)
</details>
...
<details>
  <summary>**→ Click to see GIF ←**</summary>
![Toggle Font Keyboard Menu](assets/assets/toggle-font-keyboard-menu.gif)
</details>

### Option 3 - Global Hotkey Triggering AppleScript
Use a global hotkey [[../Global Hotkeys using the Hyper Key/Global Hotkeys using the Hyper Key|Hyper]]+C to automate Option 2 (and let you toggle between two fonts)
<details>
  <summary>**→ Click to see GIF ←**</summary>
![Toggle Font Keyboard Applescript](assets/assets/toggle-font-keyboard-applescript.gif)
</details>
