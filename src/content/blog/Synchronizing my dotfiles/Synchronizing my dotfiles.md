...
description: >-
  Overtime, you accumulate a set of configurations and dotfiles. To ensure a
  consistent environments across machines you want to have access to the same
  dotfiles. I share my synchronization approach along with how to keep the
  private and public information separate.
tags:
  - tools
  - learning
  - dotfiles
pubDate: 2017-09-28T00:00:00.000Z
heroImage: assets/github-dotfiles.jpg
heroImageAlt: '''[My dotfiles repository on GitHub](https://github.com/kevinjalbert/dotfiles)'''
permalink: synchronizing-my-dotfiles
---

I always strive to [[../Share Your Bag of Tricks/Share Your Bag of Tricks|share my bag of tricks]]. Hosting [my dotfiles on GitHub](https://github.com/kevinjalbert/dotfiles) is one way I can share the tricks and tips I've picked up over time. In addition, this makes it easy to replicate my development environment on another machine if needed.
